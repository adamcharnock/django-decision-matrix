...
if not is_model_registered('ddm_core', 'Option'):
...
if not is_model_registered('ddm_core', 'Criterion'):
...
if not is_model_registered('ddm_core', 'Weight'):
...
if not is_model_registered('ddm_core', 'Score'):
...
if not is_model_registered('ddm_core', 'Category'):
